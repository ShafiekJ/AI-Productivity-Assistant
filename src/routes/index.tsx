      ...
      <div className="mx-auto max-w-6xl px-6 py-14">
        ...
        >
          ...
          <p className="mt-2 max-w-3xl">
            Monocle's tools are powered by AI models that can be wrong, incomplete or out of date.
            Treat every draft, summary, schedule and research digest as a starting point — review
            and edit before sending or acting on it, especially for anything legal, financial,
            medical or people-related.
          </p>
          <ul className="mt-3 max-w-3xl list-disc space-y-1 pl-5">
            <li>Don't paste confidential, personal or regulated data you wouldn't share with a third-party AI provider.</li>
            <li>Voice notes and text you submit are sent to an AI provider for processing.</li>
            <li>AI output is not professional advice, and a human stays accountable for the final decision.</li>
          </ul>
        </section>
      </div>
    </div>
